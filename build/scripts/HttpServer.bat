...
set CLASSPATH=%APP_HOME%\lib\HttpServer-1.0-SNAPSHOT.jar

@rem Execute HttpServer
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %HTTP_SERVER_OPTS%  -classpath "%CLASSPATH%" com.pelensky.httpserver.Main %CMD_LINE_ARGS%
